...
Garbtopia lets users browse traditional cultural costumes, overlay them on a frontal photo, and save the result — replacing photo-editing software for costume exploration.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "241315527+nickngaw-lang@users.noreply.github.com"
  git config user.name "nickngaw-lang"
  ```
